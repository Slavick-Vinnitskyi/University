...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        myList.AddList(new Bank1(43.2f, 17.9f, 18.0f, 60, 120));
        myList.AddList(new Bank2(55.6f, 19.9f, 22.0f, 48, 180));
        myList.AddList(new Bank3(49.9f, 19.9f, 19.9f, 72, 240));
        ...
        while (i){
            ...
            while (j) {
                if (chooseOrFind == 1) {
                    ...
                    float creditMany = creditAction.getNewCredit(myList, credit, suma, period);
