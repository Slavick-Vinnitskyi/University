...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Bank1 b = new Bank1(43.2f, 17.9f, 18.0f, 60, 120);
        myList.add(b);
                ...
                if (chooseOrFind == 1) {
                    ...
                    if (addAction == 4) {
                        ...
                        try {
                            ...
                            newCreditMany = newPeriod(myList, credit, sum, new_period, creditAction);
     ...
     */
    private static float newPeriod(MyList myList, int credit, int sum, int new_period, CreditAction creditAction) {

        return creditAction.getNewCredit(myList, credit, sum, new_period);
    }
